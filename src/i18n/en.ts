...
export const en: SiteContent = {
  ...
  localizations: [
    ...
    },
    {
      ...
      description:
        'Comprehensive Russian localization for cyberpunk programming simulation game Bitburner v3.0.1. Implemented via an isolated presentation DOM-observer layer without touching main.bundle.js, ensuring 100% runtime stability for player Netscript scripts, save files, and CLI commands.',
      status: 'repository / active game v3.0.1',
      ...
      imageAlt: 'Bitburner v3.0.1 Russian localization banner',
      tags: [
        'JavaScript',
        'Electron',
        'DOM Observer',
      ...
      highlights: [
        'Isolated translation layer (resources/app/dist/ru-translation.js): Real-time DOM text mutation without altering main.bundle.js.',
        'Netscript API & terminal integrity: run commands, server nodes, Netscript API calls, and code blocks strictly preserved in ASCII/English.',
        'Comprehensive game coverage: Storyline, factions, stock exchange, Bladeburner, Sleeves, Stanek, Darknet, and coding contracts.',
        'Adaptive typography: Dynamic formatting for live timestamps and units without layout overflow on stock tables.',
      ],
      links: [
        {
          label: 'GitHub Repository',
