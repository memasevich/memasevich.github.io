...
export const ru: SiteContent = {
  ...
  localizations: [
    ...
    {
      title: 'Bitburner',
      area: 'JavaScript / DOM Observer / Electron Injector',
      description:
        'Полномасштабная русификация киберпанк-симулятора программирования Bitburner v3.0.1. Реализована через изолированный презентационный слой (DOM-наблюдатель) без изменения main.bundle.js, сохраняя 100% стабильность Netscript API, скриптов игрока и терминальных команд.',
      status: 'репозиторий / актуальная игра v3.0.1',
      href: 'https://github.com/memasevich/Bitburner_ru',
      note: 'SOURCE: STEAM GUIDE / BANNER ARTWORK',
      image: '/projects/bitburner-localization.webp',
      imageAlt: 'Баннер русской локализации Bitburner v3.0.1',
      tags: [
        'JavaScript',
        'Electron',
        'DOM Observer',
      ...
      highlights: [
        'Изолированный слой перевода (resources/app/dist/ru-translation.js): перевод отображаемого DOM-текста на лету без изменения main.bundle.js.',
        'Полная защита Netscript API и терминала: команды run, /run, названия серверов, идентификаторы и скрипты игрока остаются на английском.',
        'Глубокий охват интерфейса: сюжет, аугментации, фракции, корпорации, фондовая биржа, Bladeburner, Sleeves, Stanek и контракты на кодинг.',
        'Адаптивная типографика: динамический перевод единиц времени и контекстная верстка без поломки таблиц биржи и терминала.',
      ],
      links: [
        {
          label: 'GitHub Репозиторий',
